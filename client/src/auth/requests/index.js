...
export const registerUser = (firstName, lastName, email, password, passwordVerify, avatar) => {
...
export const editUser = (firstName, lastName, password, passwordVerify, avatar) => {
    return api.put(`/editUser/`, {
        firstName: firstName,
        lastName: lastName,
        password: password,
        passwordVerify: passwordVerify,
