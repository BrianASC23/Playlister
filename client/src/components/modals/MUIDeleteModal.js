...
export default function MUIDeleteModal() {
    ...
    return (
        ...
        <Box sx={style1}>
            ...
            <Button sx={{opacity: 0.7, color: "#8932CC", backgroundColor: "#CBC3E3", fontSize: 13, fontWeight: 'bold', border: 2, p:"5px", mt:"160px", mr:"95px"}} variant="outlined" onClick={handleDeleteList}> Confirm </Button>
            <Button sx={{opacity: 0.50, color: "#8932CC", backgroundColor: "#CBC3E3", fontSize: 13, fontWeight: 'bold', border: 2, p:"5px", mt:"160px", ml:"220px"}} variant="outlined" onClick={handleCloseModal}> Cancel </Button>
